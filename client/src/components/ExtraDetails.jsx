        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div>
            ...
            <Button
              variant="contained"
              sx={{
                marginTop: "15px", marginRight: "8px", backgroundColor: "#FF6F00", color: 'white', '&:hover': { backgroundColor: "#FF6F00" },
              }}
          ...
          <div>
            ...
            <Button
              variant="contained"
              sx={{
                marginTop: "15px", backgroundColor: "#FF6F00", color: 'white', '&:hover': { backgroundColor: "#FF6F00" },
              }}
      ...
      <Grid container spacing={2} alignItems="center" lg={12} >
        <Grid item md={12} sm={12} xs={12} lg={12} style={containerStyles}>
          ...
          <Link to={'/templates'} style={linkStyle}>
            <h4 className="text-[#FF6F00]">Resume Templates</h4>
